...
class MyMailer
{
    ...
    public function mail($post, $branch, $subject, $profile_image, $enrollment = null)
    {
        ...
        $profileImagePath = $base . '/assets/profile_image/' . $profile_image;

        $header = '<div class="container">
            <table style="width: 100%; text-align: center;">
                <tr>
                    <td>
                        <img src="' . $base . '/assets/image/logo-lg.png" alt="Logo" style="max-width: 100%; width: 100px;height: 100px;" />
                    </td>
                    <td>
