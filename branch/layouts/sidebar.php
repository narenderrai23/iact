...
<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        <a href="index.php" class="logo logo-dark text-center">
            <span class="logo-sm">
                <img src="../assets/image/logo-lg.png" alt="IACT LOGO" height="22">
            </span>
            <span class="logo-lg">
                <img src="../assets/image/logo-lg.png" alt="IACT LOGO" class="w-50">
            </span>
        </a>
        ...
        <a href="index.php" class="logo logo-light text-center">
            ...
            <span class="logo-sm">
                <img src="../assets/image/favicon.png" alt="IACT LOGO" height="22">
            </span>
        </a>
    </div>
