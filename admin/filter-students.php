                                    ...
                                    <div class="p-4 border-top">
                                        <form id="filterData">
                                            <div class="row">
                                                ...
                                                <div class="col mb-3 align-self-end">
                                                    <label class="form-check-label" for="fetchStudent">
                                                        Student
                                                    </label>
                                                    <br>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="action" value="fetchStudents" id="fetchStudent" checked>
                                                        <label class="form-check-label" for="fetchStudent">New</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="action" value="fetchStudentsOld" id="fetchStudentOld">
                                                        <label class="form-check-label" for="fetchStudentOld">Old</label>
                                                    </div>
                                                </div>
                                            </div>
